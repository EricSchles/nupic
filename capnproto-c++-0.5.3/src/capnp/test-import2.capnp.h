...
#ifndef CAPNP_INCLUDED_c64a3bf0338a124a_
#define CAPNP_INCLUDED_c64a3bf0338a124a_
...
inline  ::capnp::schema::Node::Reader TestImport2::Reader::getBar() const {
  return ::capnp::_::PointerHelpers< ::capnp::schema::Node>::get(
...
inline  ::TestImport::Reader TestImport2::Reader::getBaz() const {
  return ::capnp::_::PointerHelpers< ::TestImport>::get(
...
inline void TestImport2::Builder::setBaz( ::TestImport::Reader value) {
  ::capnp::_::PointerHelpers< ::TestImport>::set(
      _builder.getPointerField(2 * ::capnp::POINTERS), value);
}
inline  ::TestImport::Builder TestImport2::Builder::initBaz() {
  return ::capnp::_::PointerHelpers< ::TestImport>::init(
      _builder.getPointerField(2 * ::capnp::POINTERS));
}
inline void TestImport2::Builder::adoptBaz(
    ::capnp::Orphan< ::TestImport>&& value) {
  ::capnp::_::PointerHelpers< ::TestImport>::adopt(
      _builder.getPointerField(2 * ::capnp::POINTERS), kj::mv(value));
}
inline ::capnp::Orphan< ::TestImport> TestImport2::Builder::disownBaz() {
  return ::capnp::_::PointerHelpers< ::TestImport>::disown(
      _builder.getPointerField(2 * ::capnp::POINTERS));
}


#endif  // CAPNP_INCLUDED_c64a3bf0338a124a_
