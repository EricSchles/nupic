...
def Enum(*args, **kwargs):
  ...
  newType.__labels = dict( (v,k) for k,v in list(kwargs.items()))
...
class Configuration(ConfigurationBase):
  ...
  def setCustomProperties(cls, properties):
    ...
    for propertyName, value in list(properties.items()):
...
class _CustomConfigurationFileWrapper(object):
  ...
  def edit(cls, properties):
    ...
    for propertyName, value in list(copyOfProperties.items()):
